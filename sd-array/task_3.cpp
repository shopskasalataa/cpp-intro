...
int main(){
    ...
    do{
        cin >> n >> k;
        /*има ли по-оптимален начин за това?*/
...
Пример:Вход:10 31 2 3 4 5 6 7 8 9 10Изход:1 4 7 10 3 6 9 2 5 8
